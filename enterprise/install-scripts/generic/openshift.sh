...
#       jbosseap_beta_repo / CONF_JBOSSEAP_BETA_REPO -- see below
...
# jbosseap_beta_repo / CONF_JBOSSEAP_BETA_REPO
#   The base URL for the JBoss EAP beta repository used with the "yum" install
#   method.  Useful for testing prerelease content.
...
YUM
  ...
  if [ "x${jbosseap_beta_repo}" != "x" ]; then
    cat <<YUM >> /etc/yum.repos.d/jbosseap.repo
[jbosseap_beta]
name=jbosseap_beta
baseurl=${jbosseap_beta_repo}
enabled=1
priority=30
gpgcheck=0
exclude= ${CONF_YUM_EXCLUDE_PKGS}
